    ...
    return (
      <main className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100">안녕하세요, {user.email || '여행자'} 님!</h1>
            <p className="mt-2 text-gray-600 dark:text-gray-300">오늘은 어떤 여행을 계획해볼까요?</p>
          </div>
          <Link 
            href="/trips/new" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-gray-700">
            <h2 className="text-xl font-semibold mb-4 flex items-center text-gray-900 dark:text-gray-100">
              <span className="bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 p-2 rounded-full mr-2">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-gray-700">
            <h2 className="text-xl font-semibold mb-4 flex items-center text-gray-900 dark:text-gray-100">
              <span className="bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 p-2 rounded-full mr-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">최근 여행</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {recentTrips.map(trip => (
                <Link 
                  key={trip.id} 
                  href={`/trips/${trip.id}`}
                  className="block bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md dark:shadow-gray-700 hover:shadow-lg dark:hover:shadow-gray-600 transition"
                >
                  ...
                  <div className="p-4">
                    ...
                    {trip.description && (
                      <p className="mt-2 text-sm text-gray-700 dark:text-gray-300 line-clamp-2">{trip.description}</p>
                    )}
                  </div>
                </Link>
              ))}
        ...
        <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
          <h2 className="text-xl font-semibold mb-3 text-gray-900 dark:text-gray-100">탐색하기</h2>
    ...
    <main className="min-h-screen wanderer-gradient-warm">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mt-16 text-center">
          <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-100">왜 다른 서비스와 다른가요?</h2>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-gray-700 text-left">
              <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-100">📍 관심 장소와 여행 계획 분리</h3>
              <p className="text-gray-600 dark:text-gray-300">
                방문하고 싶은 장소를 먼저 저장하고, 이후 실제 여행 계획에 활용할 수 있어 더 유연한 계획이 가능합니다.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-gray-700 text-left">
              <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-100">📱 실시간 위치 기반 추천</h3>
              <p className="text-gray-600 dark:text-gray-300">
