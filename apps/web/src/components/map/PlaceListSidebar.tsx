          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-semibold text-foreground">
                추가한 장소 <span className="text-muted-foreground text-sm">({totalPlaces})</span>
              </h2>
            </div>
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        {places.length === 0 ? (
          totalPlaces === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center px-4">
              <MapPin className="w-12 h-12 text-muted-foreground mb-3 opacity-50" />
              <p className="text-muted-foreground text-sm mb-2">이 지역에는 장소가 없습니다</p>
              <p className="text-muted-foreground text-xs mb-4">
                다른 지역에 <span className="font-semibold text-foreground">{totalPlaces}개</span>의 장소가 저장되어 있습니다
              </p>
              {onNavigateToNearest && (
                <button
